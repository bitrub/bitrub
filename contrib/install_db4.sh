...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the bitrub repository."
  exit 1
fi
...
# See https://github.com/bitrub/bitrub/issues/16064
...
echo 'When compiling bitrubd, run `./configure` in the following way:'
echo
