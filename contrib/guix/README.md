# Bootstrappable BitRub Core Builds

This directory contains the files necessary to perform bootstrappable BitRub
Core builds.
...
- 24GB of free disk space on the partition that the BitRub Core git repository
  resides in
...
For a BitRub Core depends development environment, simply invoke
...
From the top of a clean BitRub Core repository:
...
To use dongcarl's substitute server for BitRub Core builds after having
