...
(define* (make-bitrub-cross-toolchain target
                                  #:key
...
desirable for building BitRub Core release binaries."
...
(packages->manifest
 (list ;; The Basics
       ...
       (make-bitrub-cross-toolchain "i686-linux-gnu")
       (make-bitrub-cross-toolchain "x86_64-linux-gnu")
       (make-bitrub-cross-toolchain "aarch64-linux-gnu")
       (make-bitrub-cross-toolchain "arm-linux-gnueabihf")
       ...
       (make-bitrub-cross-toolchain "riscv64-linux-gnu"
