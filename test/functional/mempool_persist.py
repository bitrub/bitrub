...
By default, bitrubd will dump mempool on shutdown and
...
class MempoolPersistTest(BitRubTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent bitrubd from writing mempool.dat to disk. Verify that `savemempool` fails")
