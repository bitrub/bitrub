...
class P2PPermissionsTests(BitRubTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].bitrubconf, encoding="utf8") as f:
            newText=f.read().replace(old, new)
        with open(self.nodes[nodeid].bitrubconf, 'w', encoding="utf8") as f:
            f.write(newText)
