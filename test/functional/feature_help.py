...
"""Verify that starting bitrub with -h works as expected."""

from test_framework.test_framework import BitRubTestFramework
from test_framework.util import assert_equal

class HelpTest(BitRubTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bitrub with -h for help text")
        ...
        self.log.info("Start bitrub with -version for version information")
        ...
        self.log.info("Start bitrubd with -fakearg to make sure it does not start")
