...
class TestShell:
    """Wrapper Class for BitRubTestFramework.

    The TestShell class extends the BitRubTestFramework
    ...
    class __TestShell(BitRubTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by BitRubTestFramework child class.
            self.num_nodes = 1
