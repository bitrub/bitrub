BitRub Core version 0.16.3 is now available from:

  <https://bitrubcore.org/bin/bitrub-core-0.16.3/>
...
been discovered in BitRub Core versions 0.14.0 up to 0.16.2. It is recommended
...
### Miscellaneous
- #13655 `1cdbea7` bitrubconsensus: invalid flags error should be set to `bitrubconsensus_err` (afk11)
