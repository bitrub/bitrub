BitRub Core version 0.10.4 is now available from:

  <https://bitrub.org/bin/bitrub-core-0.10.4/>
...
- #6953 `43c2789` Split bitrub-tx into its own package
- #6953 `dfe0d4d` Include bitrub-tx binary on Debian/Ubuntu
