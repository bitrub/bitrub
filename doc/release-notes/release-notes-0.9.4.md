BitRub Core version 0.9.4 is now available from:

  https://bitrub.org/bin/0.9.4/
...
this update is incompatible with the BitRub system and could lead to consensus
forks.

BitRub Core released binaries from https://bitrub.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~bitrub/+archive/ubuntu/bitrub
- A third-party or self-compiled BitRub Core

upgrade to BitRub Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
