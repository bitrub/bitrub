Download URL: https://sourceforge.net/projects/bitrub/files/BitRub/bitrub-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 BTR fee schedule (users still pay 0.01 BTR per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #bitrub00 - #bitrub99
