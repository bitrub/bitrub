BitRub Core version 0.16.1 is now available from:

  <https://bitrubcore.org/bin/bitrub-core-0.16.1/>
...
- #12843 `df38b13` Test starting bitrubd with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure bitrubd processes are cleaned up when tests end (sdaftuar)
