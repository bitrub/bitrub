BitRub Core version 0.13.2 is now available from:

  <https://bitrub.org/bin/bitrub-core-0.13.2/>
...
- #8908 `4a974b2` Update bitrub-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow bitrub-tx to create v2 transactions (btrdrak)
