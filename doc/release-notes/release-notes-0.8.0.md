BitRub-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/bitrub/files/BitRub/bitrub-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the BitRub
...
New/changed settings (command-line or bitrub.conf file)
--------------------------------------------------------
