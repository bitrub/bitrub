BitRub Core version 0.9.2.1 is now available from:

  https://bitrub.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 BTR to 0.01 BTR
...
- Fix "Start bitrub on system login"
