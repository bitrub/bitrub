BitRub version 0.5.4 is now available for download at:
http://sourceforge.net/projects/bitrub/files/BitRub/bitrub-0.5.4/
...
http://gitorious.org/bitrub/bitrubd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix BitRub-Qt notifications under Growl 1.3.
Increase required age of BitRub-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBitRub properly when installing BitRub-Qt over it. (Windows)
