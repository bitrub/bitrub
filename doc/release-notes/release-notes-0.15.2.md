BitRub Core version *0.15.2* is now available from:

  <https://bitrubcore.org/bin/bitrub-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in bitrub-tx (TheBlueMatt)
