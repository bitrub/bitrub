...
//! Entry point for BitRubApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &BitRubApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for BitRubGUI tests.
void AppTests::guiTests(BitRubGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &BitRubGUI::consoleShown, this, &AppTests::consoleTests);
