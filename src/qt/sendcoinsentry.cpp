    ...
    platformStyle(_platformStyle)
{
    ...
    // normal bitrub address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying bitrub address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &BitRubAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
