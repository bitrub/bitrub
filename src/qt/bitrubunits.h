...
#ifndef BITRUB_QT_BITRUBUNITS_H
#define BITRUB_QT_BITRUBUNITS_H
...
/** BitRub unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class BitRubUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit BitRubUnits(QObject *parent);

    /** BitRub units.
      @note Source: https://en.bitrub.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        BTR,
...
typedef BitRubUnits::Unit BitRubUnit;

#endif // BITRUB_QT_BITRUBUNITS_H
