...
#ifndef BITRUB_WALLET_SCRIPTPUBKEYMAN_H
#define BITRUB_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The BitRub Core wallet was originally a collection of unrelated private
...
#endif // BITRUB_WALLET_SCRIPTPUBKEYMAN_H
