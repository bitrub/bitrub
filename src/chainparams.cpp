...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed.bitrub.sipa.be"); // Pieter Wuille, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("dnsseed.bluematt.me"); // Matt Corallo, only supports x9
        vSeeds.emplace_back("dnsseed.bitrub.dashjr.org"); // Luke Dashjr
        vSeeds.emplace_back("seed.bitrubstats.com"); // Christian Decker, supports x1 - xf
        vSeeds.emplace_back("seed.bitrub.jonasschnelli.ch"); // Jonas Schnelli, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("seed.btr.petertodd.org"); // Peter Todd, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("seed.bitrub.sprovoost.nl"); // Sjors Provoost
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.bitrub.jonasschnelli.ch");
        vSeeds.emplace_back("seed.tbtr.petertodd.org");
        vSeeds.emplace_back("seed.testnet.bitrub.sprovoost.nl");
