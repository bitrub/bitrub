...
#ifndef BITRUB_CRYPTO_CHACHA_POLY_AEAD_H
#define BITRUB_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@bitrub.
 *
 ...
 *
 * The chacha20-poly1305@bitrub combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@bitrub cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@bitrub are relatively fast in
...
#endif // BITRUB_CRYPTO_CHACHA_POLY_AEAD_H
