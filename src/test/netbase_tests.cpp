// Copyright (c) 2012-2019 The BitRub Core developers
...
{
    BOOST_CHECK(TestSplitHost("www.bitrubcore.org", "www.bitrubcore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.bitrubcore.org]", "www.bitrubcore.org", -1));
    BOOST_CHECK(TestSplitHost("www.bitrubcore.org:80", "www.bitrubcore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.bitrubcore.org]:80", "www.bitrubcore.org", 80));
