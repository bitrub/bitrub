...
#ifndef BITRUB_TEST_SCRIPTNUM10_H
#define BITRUB_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from BitRub Core 0.10.0, for cross-comparison.
 */
public:
