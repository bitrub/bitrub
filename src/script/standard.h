...
#ifndef BITRUB_SCRIPT_STANDARD_H
#define BITRUB_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a bitrub address
 */
...
/**
 * Generate a BitRub scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // BITRUB_SCRIPT_STANDARD_H
