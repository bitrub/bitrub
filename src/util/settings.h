...
#ifndef BITRUB_UTIL_SETTINGS_H
#define BITRUB_UTIL_SETTINGS_H
...
//!       https://github.com/bitrub/bitrub/pull/15934/files#r337691812)
using SettingsValue = UniValue;

//! Stored bitrub settings. This struct combines settings from the command line
